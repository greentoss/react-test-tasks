...
import CartPopUpOverlay from "../CartPopUpOverlay/CartPopUpOverlay"
...
class Header extends React.Component {
    ...
    openModal = () => {
        this.setState({ openCartOverlay: true });
    };
    ...
    render() {
        ...
        <header className='header'>
            <nav className="header-menu">
                <ul>
                    <li><Link to='/' className='nav-link' href="#">Women</Link></li>
                    <li><a className='nav-link' href="#">Men</a></li>
                    <li><a className='nav-link' href="#">Kids</a></li>
                </ul>
            </nav>
            <div><img src={logo} className="App-logo" alt="logo" /></div>
            <div style={{display: 'flex'}}>
                <SelectCurrency />
                <div className='cart-icon-div' onClick={() => {
                    this.openModal()
                    this.freezeScroll()
                }
                }>
                    <div >
                        ...
                        <button className='cart-icon-total-number'>3</button>
                    </div>

                </div>
            </div>
            <CartPopUpOverlay
                trigger={this.state.openCartOverlay}
